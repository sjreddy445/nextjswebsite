        ...
        <div className="footer">
          ...
          <div className="bold-grey-bg">
            ...
            <div className="container-inner py-2 d-flex justify-content-between">
              ...
              <p className="text-right text-grey1 text-xxs sm-text-left m-0 py-2 md-6">{year} {this.state?.data?.description4}|<NavLink href="/privacy" className="link-no-decor"> Privacy Policy</NavLink> | <span onClick={this.toggleCreditModal} className="pointer">Credits</span></p>
            </div>
          </div>
        </div>
      </>
